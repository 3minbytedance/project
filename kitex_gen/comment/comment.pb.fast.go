...
func (x *CommentCountRequest) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_CommentCountRequest[number], err)
}

func (x *CommentCountRequest) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.VideoId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *CommentCountResponse) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_CommentCountResponse[number], err)
}

func (x *CommentCountResponse) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.StatusCode, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *CommentCountResponse) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	tmp, offset, err := fastpb.ReadString(buf, _type)
	x.StatusMsg = &tmp
	return offset, err
}

func (x *CommentCountResponse) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *CommentCountRequest) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *CommentCountRequest) fastWriteField1(buf []byte) (offset int) {
	if x.VideoId == 0 {
		return offset
	}
...
func (x *CommentCountResponse) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *CommentCountResponse) fastWriteField1(buf []byte) (offset int) {
	if x.StatusCode == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 1, x.GetStatusCode())
...
func (x *CommentCountResponse) fastWriteField2(buf []byte) (offset int) {
	if x.StatusMsg == nil {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 2, x.GetStatusMsg())
...
func (x *CommentCountResponse) fastWriteField3(buf []byte) (offset int) {
	if x.CommentCount == 0 {
		return offset
	}
...
func (x *CommentCountRequest) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *CommentCountRequest) sizeField1() (n int) {
	if x.VideoId == 0 {
		return n
	}
...
func (x *CommentCountResponse) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *CommentCountResponse) sizeField1() (n int) {
	if x.StatusCode == 0 {
		return n
	}
	n += fastpb.SizeUint32(1, x.GetStatusCode())
...
func (x *CommentCountResponse) sizeField2() (n int) {
	if x.StatusMsg == nil {
		return n
	}
	n += fastpb.SizeString(2, x.GetStatusMsg())
...
func (x *CommentCountResponse) sizeField3() (n int) {
	if x.CommentCount == 0 {
		return n
	}
...
var fieldIDToName_CommentCountRequest = map[int32]string{
	1: "VideoId",
}

var fieldIDToName_CommentCountResponse = map[int32]string{
	1: "StatusCode",
	2: "StatusMsg",
	3: "CommentCount",
}
