...
func (p *CommentCountRequest) GetVideoId() (v int32) {
	return p.VideoId
}
func (p *CommentCountRequest) SetVideoId(val int32) {
	p.VideoId = val
}
...
func (p *CommentCountRequest) Field1DeepEqual(src int32) bool {
...
func (p *CommentCountResponse) GetCommentCount() (v int32) {
...
func (p *CommentCountResponse) SetCommentCount(val int32) {
	p.CommentCount = val
}
...
func (p *CommentCountResponse) Field3DeepEqual(src int32) bool {
...
type CommentService interface {
	...
	GetCommentCount(ctx context.Context, request *CommentCountRequest) (r *CommentCountResponse, err error)
}
...
func (p *CommentServiceClient) GetCommentCount(ctx context.Context, request *CommentCountRequest) (r *CommentCountResponse, err error) {
...
func (p *commentServiceProcessorGetCommentCount) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.GetCommentCount(ctx, args.Request); err2 != nil {
...
type CommentServiceGetCommentCountArgs struct {
	Request *CommentCountRequest `thrift:"Request,1" frugal:"1,default,CommentCountRequest" json:"Request"`
}
...
var CommentServiceGetCommentCountArgs_Request_DEFAULT *CommentCountRequest

func (p *CommentServiceGetCommentCountArgs) GetRequest() (v *CommentCountRequest) {
	if !p.IsSetRequest() {
		return CommentServiceGetCommentCountArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *CommentServiceGetCommentCountArgs) SetRequest(val *CommentCountRequest) {
	p.Request = val
}
...
func (p *CommentServiceGetCommentCountArgs) IsSetRequest() bool {
	return p.Request != nil
}
...
func (p *CommentServiceGetCommentCountArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewCommentCountRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *CommentServiceGetCommentCountArgs) Field1DeepEqual(src *CommentCountRequest) bool {
...
var CommentServiceGetCommentCountResult_Success_DEFAULT *CommentCountResponse

func (p *CommentServiceGetCommentCountResult) GetSuccess() (v *CommentCountResponse) {
	if !p.IsSetSuccess() {
...
func (p *CommentServiceGetCommentCountResult) Field0DeepEqual(src *CommentCountResponse) bool {
