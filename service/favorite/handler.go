...
func (s *FavoriteServiceImpl) GetVideoFavoriteCount(ctx context.Context, req *favorite.VideoFavoriteCountRequest) (resp *favorite.VideoFavoriteCountResponse, err error) {
	// TODO: Your code here...
	return
}

// GetUserFavoriteCount implements the FavoriteServiceImpl interface.
func (s *FavoriteServiceImpl) GetUserFavoriteCount(ctx context.Context, req *favorite.UserFavoriteCountRequest) (resp *favorite.UserFavoriteCountResponse, err error) {
	// TODO: Your code here...
	return
}
