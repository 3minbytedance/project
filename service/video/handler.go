...
func (s *VideoServiceImpl) VideoFeed(ctx context.Context, req *video.VideoFeedRequest) (resp *video.VideoFeedResponse, err error) {
	// TODO: Your code here...
	return
}
...
func (s *VideoServiceImpl) GetPublishVideoList(ctx context.Context, req *video.PublishVideoListRequest) (resp *video.PublishVideoListResponse, err error) {
	// TODO: Your code here...
	return
}
